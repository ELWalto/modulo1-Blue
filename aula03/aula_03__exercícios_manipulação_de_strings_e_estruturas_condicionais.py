# -*- coding: utf-8 -*-
"""Cópia de Aula_03_- Exercícios - Manipulação_de_Strings_e_Estruturas_Condicionais.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1txTAp0i6nD0eUna1XT1O2Q3szTW0BpvE
...
# Aluno aprovado?
nota1 = float(input("Vamos ver se você foi aprovado? \n Informe a primeira nota: ").replace("," , "."))
...
# # informação de genero
# sexo = str(input("informe seu sexo com F ou M "))
# if sexo == "F" or "f":
#   print("feminino")
